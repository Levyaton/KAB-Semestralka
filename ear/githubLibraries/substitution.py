...
from ear.githubLibraries.cipher import Cipher
from itertools import combinations
from ear.githubLibraries.utils import STANDARD_ALPHABET, STANDARD_ALPHABET_FREQUENCIES, ALLOWED_PUNCTUATION
...
class Substitution(Cipher):
    ...
    def __init__(self, trigrams_path):
        """
        ...
        for line in open(trigrams_path):
